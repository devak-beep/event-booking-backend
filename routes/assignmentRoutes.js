...
router.post('/:id/return', authenticate, authorize('superadmin', 'admin', 'manager'), logActivity('RETURN', 'Asset'), assignmentController.returnAsset.bind(assignmentController));
...
router.put('/:id', authenticate, authorize('superadmin', 'admin', 'manager'), logActivity('UPDATE', 'Assignment'), assignmentController.updateAssignment.bind(assignmentController));
router.get('/asset/:assetId', authenticate, assignmentController.getAssignmentByAsset.bind(assignmentController));
